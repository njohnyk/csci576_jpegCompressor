...
public class SpectralSelection extends JPanel {
    ...
    public SpectralSelection(BufferedImage image, int quantizationLevel) {
        this.image = image;
    ...
    public int[][] encodeChannelBlock(int[][] block, int level) {
        ...
        int[][] modifiedSpectralSelection = spectralSelection(level);
    ...
    public int[][] spectralSelection(int count) {
